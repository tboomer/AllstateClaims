# Run random forest inside caret wrapper using 5-fold CV.
# ***NOTE: this script cannot get through a single fold even when running
# over night.*********
...
set.seed(56)
rf_model <- train(x = trainX, y = train$logloss,
                  method = "rf",
                  trControl = ctrl,
                  tuneGrid = tune,
                  metric = "MAE",
